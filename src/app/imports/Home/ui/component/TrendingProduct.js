          ...
          <div className="col-lg-3 col-sm-6 custom-width-20">
            <div className="product-wrapper mb-40">
              <div className="pro-img mb-20">
                <a href="product-details.html">
                  <img
                    src="img/product/product-36.jpg"
                    className="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div className="col-lg-3 col-sm-6 custom-width-20">
            <div className="product-wrapper mb-40">
              <div className="pro-img mb-20">
                <a href="product-details.html">
                  <img
                    src="img/product/product-37.jpg"
                    className="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div className="col-lg-3 col-sm-6 custom-width-20">
            <div className="product-wrapper mb-40">
              <div className="pro-img mb-20">
                <a href="product-details.html">
                  <img
                    src="img/product/product-38.jpg"
                    className="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div className="col-lg-3 col-sm-6 custom-width-20">
            <div className="product-wrapper mb-40">
              <div className="pro-img mb-20">
                <a href="product-details.html">
                  <img
                    src="img/product/product-39.jpg"
                    className="img-fluid"
                    alt=""
                  />
                </a>
